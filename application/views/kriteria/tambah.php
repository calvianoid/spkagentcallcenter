        ...
        <div class="panel-body">
            ...
            <?php echo form_open('',array('class' => 'form-horizontal'))?>
                <div class="form-group">
                    <?php echo form_label('Kode :', '',array('for' => 'inputKriteria', 'class' => 'col-sm-2 control-label')) ?>
                    <div class="col-sm-10">
                        <?php echo form_input('kriteria', set_value('kriteria'), array('id' => 'inputKriteria', 'class' =>'form-control' )) ?>
                    </div>
                </div>
                <div class="form-group">
                    <?php echo form_label('Kriteria :', '',array('for' => 'inputNamaKriteria', 'class' => 'col-sm-2 control-label')) ?>
                    <div class="col-sm-10">
                        <?php echo form_input('nama_kriteria', set_value('nama_kriteria'), array('id' => 'inputNamaKriteria', 'class' =>'form-control' )) ?>
                    </div>
                </div>
                <div class="form-group">
