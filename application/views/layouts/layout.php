            ...
            <div class="container">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand active" href="<?php echo site_url()?>">SPK KARYAWAN BARU AGENT CALL CENTER</a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            ...
                            ><a href="<?php echo site_url('universitas');?>">Karyawan Baru Agent Call Center</a></li>
                            <li
