...
class Kriteria extends MY_Controller
{
    ...
    private function getValidationInsert()
    {
        $validation = array(
            ...
            array('field' => 'nama_kriteria', 'label' => '', 'rules' => 'trim|required'),
            array('field' => 'sifat', 'label' => '', 'rules' => 'trim|required'),
            array('field' => 'bobot', 'label' => '', 'rules' => 'trim|required'),
    ...
    public function tambah()
    {
        if (count($_POST)) {
            ...
            if ($this->form_validation->run() == false) {
                ...
                $this->MKriteria->nama_kriteria = $this->input->post('nama_kriteria', true);
